...
#Merge the data to generate a unique dataset

###FIRST COMBINE THE DATA TABLES BY ROWS ON THE "ACTIVITY" FILES
...
###USE THE names() FUNCTION IN ORDER TO SET NAMES OF THE DATA OBJECTS
...
### MERGE DATA USING THE "cbind()" FUNCTION TO COMBINE THE DATA FRAME BY COLUMNS
...
### 7.1 Subset Name of Features by measurements on the mean "mean()" and standard "std()" deviation
